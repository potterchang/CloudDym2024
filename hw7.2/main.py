...
vtls = VVMTools(case_path=f"{MotherDir}/{expname}")
...
def loadData(t0, t1, xIdx):
    ...
    BLH3 = vtls.find_BL_boundary(tke, "threshold", threshold=0.08)
    BLH4 = vtls.find_BL_boundary(enstrophy, "threshold", threshold=1e-5)
