...
zc = ds['zc']
tke = ds['tke']
enstrophy = ds['enstrophy']
th = ds['th']
time_range = pd.date_range(start="2024-01-01 05:00", end="2024-01-02 05:00", freq="2T")
...
ax.set_xlim([time_range[120], time_range[400]])
...
plt.savefig("PBL.png", bbox_inches='tight')
