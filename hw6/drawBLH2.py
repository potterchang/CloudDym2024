...
PC2 = ax.contour(time_range, zc, wanothano0.T, levels=[0.01], colors=["tab:purple"], linestyles='--',alpha=0.7)
PC2 = ax.contour(time_range, zc, wanothano1.T, levels=[0.01], colors=["tab:purple"], linestyles='-')
PC2_legend = Line2D([0], [0], linestyle='-', color='tab:purple',linewidth=1.5)
...
all_handles = [PC0_legend, PC1_legend, PC2_legend, L1[0], L2[0], L3legend, L4legend]
all_labels = ['TKE=0.2', 'Enstrophy=2e-5', r"$w'\theta'=0.01$",r'$\theta_{sfc}+0.5K$', r'max $d\theta/dz$', 'Pasture Avg.', 'Urban Avg.']
